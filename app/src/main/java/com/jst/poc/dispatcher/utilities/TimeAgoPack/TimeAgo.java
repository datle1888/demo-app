...
public class TimeAgo {
  ...
  private String suffixAgo = Messages.getString(Messages.AGO); //$NON-NLS-1$

  private String suffixFromNow = Messages
      .getString(Messages.SUFFIX_FROM_NOW); //$NON-NLS-1$

  private String seconds = Messages.getString(Messages.SECONDS); //$NON-NLS-1$

  private String minute = Messages.getString(Messages.MINUTE); //$NON-NLS-1$

  private String minutes = Messages.getString(Messages.MINUTES); //$NON-NLS-1$

  private String hour = Messages.getString(Messages.HOUR); //$NON-NLS-1$

  private String hours = Messages.getString(Messages.HOURS); //$NON-NLS-1$

  private String day = Messages.getString(Messages.DAY); //$NON-NLS-1$

  private String days = Messages.getString(Messages.DAYS); //$NON-NLS-1$

  private String month = Messages.getString(Messages.MONTH); //$NON-NLS-1$

  private String months = Messages.getString(Messages.MONTHS); //$NON-NLS-1$

  private String year = Messages.getString(Messages.YEAR); //$NON-NLS-1$

  private String years = Messages.getString(Messages.YEARS); //$NON-NLS-1$
